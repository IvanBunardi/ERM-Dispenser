...
export default function StatsPage() {
  ...
  const bottles = useCountUp(guest?.bottlesSaved ?? 250);
  const co2 = useCountUp(Math.round((guest?.co2Reduced ?? 14.2) * 10), 1500);
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 md:py-8">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-2 flex-wrap">
                  <span className="text-xs font-bold text-eco-600 bg-eco-100 px-2 py-0.5 rounded-full">
                    +{guest?.weeklyChange ?? 12}% this week
                  </span>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-1.5 mt-2">
                  ...
                  <span className="text-xs font-semibold text-eco-600">
                    {guest?.ecoLevel ?? 'Emerald'} Level
                  </span>
                </div>
              </div>
              <CircularProgress value={75} size={80} strokeWidth={8} color="#22C55E" />
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="text-sm font-semibold text-primary-700 hover:text-primary-800">
              View All
            </button>
          </div>
